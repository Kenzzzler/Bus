...
class MainActivity : AppCompatActivity() {
    ...
    private fun pass() {
        when (numPass) {
            ...
            in 10..Int.MAX_VALUE -> { // это уже не обязательно, но визуально понятнее,
                pass.setTextColor(Color.RED) // что у нас допускается условно бесконечный счет
